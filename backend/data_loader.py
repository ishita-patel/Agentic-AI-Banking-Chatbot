...
class BankDataLoader:
    ...
    def get_user(self, user_id):
        ...
        # Skip decryption if plaintext data already exists
        # Your MongoDB documents contain both plaintext and encrypted fields
        if (
    ...
    def get_balance(self, user_id, account_type=None):
        ...
        if (
            account_type
            and account_type in user["accounts"]
        ):
